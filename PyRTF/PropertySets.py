...
#
class MarginsPropertySet(object) :
...
class ShadingPropertySet(object) :
	HORIZONTAL             =  1
	VERTICAL               =  2
	FORWARD_DIAGONAL       =  3
	BACKWARD_DIAGONAL      =  4
...
class BorderPropertySet(object) :
	SINGLE	  = 1
	DOUBLE    = 2
	SHADOWED  = 3
	DOUBLED   = 4
...
class ParagraphPropertySet(object) :
	LEFT	   = 1
	RIGHT      = 2
	CENTER	   = 3
	JUSTIFY	   = 4
